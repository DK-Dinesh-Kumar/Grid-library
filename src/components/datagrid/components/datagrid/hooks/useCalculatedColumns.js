...
export function useCalculatedColumns({
  ...
  const defaultFormatter = defaultColumnOptions?.cellRenderer ?? valueFormatter
  ...
  const {
    ...
    const columns = rawColumns.map(rawColumn => {
      ...
      const column = {
        ...
        cellRenderer: rawColumn.cellRenderer ?? defaultFormatter
      }

      console.log("rawCodflumn",column)
