...
function AgGrid(props, ref) {
  ...
  console.log("raa", rawHeaderRowHeight);
  const defaultComponents = useDefaultComponents();
  const height = rawRowHeight ?? 24;
  const rowHeight = rawRowHeight ?? 24;
  var headerRowHeight =
    rawHeaderRowHeight ?? (typeof height === "number" ? rowHeight : 24);

  // if(rawColumns.aaa){
  // 	headerRowHeight=headerRowHeight*2
  // }
  ...
  console.log("topSummaryRowsCount", topSummaryRowsCount);
  ...
  useLayoutEffect(() => {
    ...
    setColumnWidths((columnWidths) => {
      ...
      for (const column of flexWidthViewportColumns) {
        ...
        console.log("newColumnWidths1", rawColumns);
      }
  ...
  function getLayoutCssVars() {
    ...
    const newTemplateColumns = [...templateColumns];
    console.log("asdfgh", newTemplateColumns);
    for (const column of flexWidthViewportColumns) {
  ...
  function getRowViewportColumns(rowIdx) {
    ...
    console.log("ffxf", viewportColumns);
  ...
  console.log("te11", templateRows);
  if (topSummaryRowsCount > 0) {
    templateRows += ` repeat(${topSummaryRowsCount}, ${summaryRowHeight}px)`;
  }
  if (rows.length > 0) {
    templateRows = templateRows + gridTemplateRows;
    console.log("te", templateRows);
  }
  ...
  return (
    <div
      ...
      style={{
        ...style,
        // gridTemplateColumns:
        //   "35px 80px 230px 230px 120px 180px 160px 150px 110px 100px 100px 100px 128.262px 150px 80px 80px",
